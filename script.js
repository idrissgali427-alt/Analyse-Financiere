document.addEventListener('DOMContentLoaded', () => {
    ...
    // CODE DE PROTECTION - PLACÉ AU DÉBUT DE LA LOGIQUE
    ...
    if (motDePasseSaisi !== motDePasseRequis) {
        ...
        return; // Important pour arrêter l'exécution si le mot de passe est incorrect
    }

    alert('Accès accordé !');

    // C'est ici que commence tout le reste de votre application
    // Le code suivant s'exécutera uniquement si le mot de passe est correct
    ...
    // Affiche l'heure et la date une seule fois au chargement pour éviter le mouvement constant
    updateDateTime();
